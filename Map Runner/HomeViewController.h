...
@property(nonatomic,readwrite)CGFloat ywidthbob,ywidthsim,simTop,simLeft,bobleftmargin,bobtopmargin,bobrightmargin,bobdownmarign;
...
@property(nonatomic,readwrite)long score,CURRENT_SCORE,Updatescoretime,Score_startTime,Score_timeInMilliseconds,Score_timeSwapBuff,Score_updatedTime,STARTSEC , CURRENTSEC,redline,updatemint,timeSwapBuff,scoreValuess;
